...
function Features() {
    return <section className="full_screen_section flex flex-col  items-center justify-center px-16 gap-8  landing_features" id="features">
        <h1>Explore Our Features</h1>
        <div className="features_list flex flex-col lg:flex-row items-center justify-center lg:space-x-12 space-y-8 lg:space-y-0">
            <Feature
                icon={<Icon name={"calendar_todo"} size={24} color={"icon_secondary"} />}
            ...
            />
            <Feature
                icon={<Icon name={"group_users"} 
                size={24} color={"icon_secondary"} />} 
                title={"Community"} 
